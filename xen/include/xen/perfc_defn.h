...
PERFCOUNTER(sched_wakeup,           "sched: total wakeups")
PERFCOUNTER(sched_wakeup_direct,    "sched: direct wakeups")
PERFCOUNTER(sched_wakeup_defer,     "sched: deferred wakeups")
//PERFCOUNTER(sched_wakeup_on_wlist,  "sched: vcpu already on wake list")
PERFCOUNTER(sched_wakeup_dfr_hndl,  "sched: calls to wakeup handler")
PERFCOUNTER(sched_wakeup_hndl_iters,"sched: wakeup iterations")
PERFCOUNTER(sched_wakeup_newcpu,    "sched: wakeup retrigered")
